...
public class PreferenceConfiguration {
    ...
    private static final String ENABLE_MULTITOUCH_PREF_STRING = "checkbox_enable_multitouch";
    ...
    private static final boolean DEFAULT_ENABLE_MULTITOUCH = false;
    ...
    public boolean enableMultitouch;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.enableMultitouch = prefs.getBoolean(ENABLE_MULTITOUCH_PREF_STRING, DEFAULT_ENABLE_MULTITOUCH);
        config.multiTouchGestures = prefs.getBoolean(MULTI_TOUCH_GESTURES_PREF_STRING, DEFAULT_MULTI_TOUCH_GESTURES);
