...
public class VirtualKeyboard {
    ...
    /*package*/ VirtualKeyboardLayout keyboardLayout = VirtualKeyboardLayout.ENGLISH;
    private int deck = 0;
    ...
    public VirtualKeyboard(FrameLayout layout, final Game game) {
        ...
        int key_width = screen.widthPixels / 13;
        int key_height = (screen.heightPixels / 2) / 6;
    ...
    private void move(int direction) {
        ...
        if (current != null) {
            Point nextPos = findNext(current.pos, direction);
